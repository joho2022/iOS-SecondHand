...
struct HomeView: View {
            ...
            ZStack {
                ...
                .fullScreenCover(item: $selectedProduct) { product in
                    ProductDetailView(viewModel: ProductDetailViewModel(product: product,
                                                                        isSeller: isSeller(product: product),
                                                                        productManager: productManager,
                                                                        userManager: userManager), isPresentingDetailView: $isPresentingDetailView)
                }
            }
        }
    ...
    private func isSeller(product: Product) -> Bool {
        guard let user = userManager.user else { return false }
        return user.username == product.user
    }
