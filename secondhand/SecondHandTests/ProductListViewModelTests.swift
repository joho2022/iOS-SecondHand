...
class MockProductManager: ProductManagerProtocol {
    ...
    func loadMockProducts() {
        let mockProducts: [Product] = [
            Product(id: 0, title: "나이키 티셔츠", price: 40000, location: "역삼동", category: [.popular], images: ["https://kream-phinf.pstatic.net/MjAyMzA0MTRfMjAw/MDAxNjgxNDUxNDAyMTUz.5q0cKoTNu0T3fLSHXHRomwuYI5EE3bxDXCcjHFeZnuUg.ts4o7ZUeK19uolxTSWNmVNDCr_mg9472IQ0YZcj0heIg.JPEG/a_d7263afeb4e04111abafbda2b5b67bea.jpg?type=l_webp"], timePosted: "2024-06-10T13:14:08", likes: 10, comments: 2, views: 0, status: .reserved, user: "100", description: "멋진 나이키 티셔츠입니다."),
            Product(id: 1, title: "조던 신발", price: 500000, location: "역삼동", category: [.popular], images: ["https://kream-phinf.pstatic.net/MjAyNDA1MjRfMzkg/MDAxNzE2NTMyODQzNTgy.ECw3Xikv8w6R1-zs-OcQyVY-SMAN1tSInutYzMkUmNkg.cI4OQfPajMr34SNzLX32WaNQopL02vNol6_yWMQyl8gg.PNG/a_0a36d3746db04595871a75bcc6798e02.png?type=l_webp"], timePosted: "2024-06-10T13:14:08", likes: 25, comments: 5, views: 0, status: .reserved, user: "101", description: "새로운 조던 신발입니다.")
        ]
